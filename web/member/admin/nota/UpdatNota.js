        ...
        <form className='w-50 mx-auto' onSubmit={Upp}>
            ...
            <div className='form-floating'>
                <input className='form-control mb-2'
                    ...
                    <label htmlFor='id_nota'>Id Barang</label>
            </div>
            <div className='form-floating'>
                <input className='form-control mb-2'
                        id='id_nota' type='text' placeholder='Harga' required
                        value = {_harga} onChange ={(e) => setHarga(e.target.value)} />

                    <label htmlFor='id_nota'>Harga</label>
            </div>
            <div className='form-floating'>
                <input className='form-control mb-2'
                        id='id_nota' type='text' placeholder='Order By' required
                        value = {_order_by} onChange ={(e) => setOrderby(e.target.value)} />

                    <label htmlFor='id_nota'>Order By</label>
            </div>
